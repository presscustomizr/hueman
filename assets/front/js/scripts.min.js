...
c.scrollDirection(a>=d?"down":"up")}),b.$_window.resize(function(a){c.windowWidth(b.$_window.width())}),b.$_window.scroll(function(){c.isScrolling(!0),c.scrollPosition(b.$_window.scrollTop()),clearTimeout(a.data(this,"scrollTimer")),a.data(this,"scrollTimer",setTimeout(function(){c.isScrolling(!1)},100))})}};b.methods.UserXP=b.methods.UserXP||{},a.extend(b.methods.UserXP,c)}(jQuery,czrapp);var czrapp=czrapp||{};!function(a,b){var c={mobileMenu:function(){var c=this;c.mobileMenu=new b.Values,a(".nav-container").each(function(d){if(_.isString(a(this).attr("data-menu-id"))){var e,f=a(this),g=!_.isString(a(this).attr("data-menu-scrollable"))||"false"!=a(this).attr("data-menu-scrollable"),h=f.attr("data-menu-id");if(!c.mobileMenu.has(h)){var i=f.find(".nav-wrap");1!=i.length&&b.errorLog("Mobile menu : misssing .nav-wrap for menu-id : "+h);var j=".nav-toggle, .ham__navbar-toggler, .ham__navbar-toggler-two",k=f.find(j);1!=k.length&&b.errorLog("Mobile menu : misssing container for menu-id : "+h),e=b.Value.extend(c.MobileCTOR),c.mobileMenu.add(h,new e(h,{container:f,menu_wrapper:i,button:k,button_selectors:j,is_scrollable:g}))}}})},MobileCTOR:{initialize:function(c,d){var e=this;b.Value.prototype.initialize.call(e,null,d),a.extend(e,d||{}),e("collapsed"),e.bind(function(b){return a.Deferred(function(){var a=this;e._toggleMobileMenu().done(function(b){e.button.toggleClass("hovering","expanded"==b).toggleClass("focusing","expanded"==b),a.resolve()})}).promise()},{deferred:!0}),b.setupDOMListeners([{trigger:"click keydown",selector:e.button_selectors,actions:function(){var a=this;a("collapsed"==a()?"expanded":"collapsed")}},{trigger:"mouseenter",selector:e.button_selectors,actions:function(){this.button.addClass("hovering")}},{trigger:"mouseleave",selector:e.button_selectors,actions:function(){this.button.removeClass("hovering")}}],{dom_el:e.container},e),b.userXP.isResizing.bind(function(a){a&&e("collapsed")})},_toggleMobileMenu:function(){var c=this,d="expanded"==c(),e=a.Deferred();return c.button.toggleClass("collapsed",!d).toggleClass("active",d).attr("aria-expanded",d),a.when(c.menu_wrapper.toggleClass("expanded",d)).done(function(){var f=a(this);f.find(".nav").stop()[d?"slideDown":"slideUp"]({duration:350,complete:function(){if(c.is_scrollable){var a="undefined"==typeof window.innerHeight?window.innerHeight:b.$_window.height(),g=a-f.offset().top+b.$_window.scrollTop();f.css({"max-height":d?g:"",overflow:"auto"})}e.resolve(d)}})}),e.promise()}}};b.methods.UserXP=b.methods.UserXP||{},a.extend(b.methods.UserXP,c)}(jQuery,czrapp);var czrapp=czrapp||{};!function(a,b){var c={stickify:function(){var c=this;this.menuWrapper=!1,this.stickyMenuDown=new b.Value("_not_set_"),this.stickyHeaderThreshold=50,this.currentStickySelector=new b.Value(""),this.hasStickyCandidate=new b.Value((!1)),this.stickyHeaderAnimating=new b.Value((!1)),this.currentStickySelector.bind(function(a,d){_.isEmpty(a)?(b.$_header.css({height:""}).removeClass("fixed-header-on"),c.stickyMenuDown(!1),c.menuWrapper=!1,c.hasStickyCandidate(!1)):(c.menuWrapper=b.$_header.find(a),c.hasStickyCandidate(1==c.menuWrapper.length),b.$_header.css({height:b.$_header.height()}).addClass("fixed-header-on"))}),this.scrollPosition.bind(function(a,b){Math.abs(a-b)<=5||c.stickyMenuDown(a<b)}),b.bind("scrolling-finished",function(){"up"==c.scrollDirection()&&c._mayBeresetTopPosition()}),c.stickyMenuDown.validate=function(a){return c.scrollPosition()<c.stickyHeaderThreshold&&!a?(c.isScrolling()||b.errorLog("Menu too close from top to be moved up"),c.stickyMenuDown()):a},c.stickyMenuDown.bind(function(b,d,e){return _.isBoolean(b)?(e=_.extend({direction:b?"down":"up",force:!1,menu_wrapper:c.menuWrapper,fast:!1},e||{}),c._animate({direction:e.direction,force:e.force,menu_wrapper:e.menu_wrapper,fast:e.fast})):a.Deferred(function(){return this.resolve().promise()})},{deferred:!0}),c.isResizing.bind(function(d){c._setStickySelector(),c.stickyMenuDown(c.scrollPosition()<c.stickyHeaderThreshold,{fast:!0}).done(function(){b.$_header.css("height","").removeClass("fixed-header-on"),c.hasStickyCandidate()&&b.$_header.css("height",b.$_header.height()).addClass("fixed-header-on")}),c._isMobile()?(a(".full-width.topbar-enabled #header").css("padding-top",""),c._mayBeresetTopPosition()):c._adjustDesktopTopNavPaddingTop()}),c._setStickySelector(),c._isMobile()||c._adjustDesktopTopNavPaddingTop()},_setStickySelector:function(){var a=this,b={"only screen and (max-width: 719px)":"mobile-sticky","only screen and (min-width: 720px)":"desktop-sticky"},c=!1;_.each(b,function(a,b){_.isFunction(window.matchMedia)&&matchMedia(b).matches&&(c=[".nav-container",a].join("."))}),a.currentStickySelector(c)},_adjustDesktopTopNavPaddingTop:function(){var c=this;c._isMobile()||c.hasStickyCandidate()&&a(".full-width.topbar-enabled #header").css("padding-top",b.$_header.find(c.currentStickySelector()).outerHeight())},_mayBeresetTopPosition:function(){var b=this,c=b.menuWrapper;"up"==b.scrollDirection()&&c.length&&(b.scrollPosition()>=b.stickyHeaderThreshold||(b._isMobile()||b._adjustDesktopTopNavPaddingTop(),b.stickyMenuDown(!0,{force:!0,fast:!0}).done(function(){b.stickyHeaderAnimating(!0),function(){return a.Deferred(function(){var a=this;_.delay(function(){"up"==b.scrollDirection()&&b.scrollPosition()<10&&c.css({"-webkit-transform":"","-moz-transform":"","-ms-transform":"","-o-transform":"",transform:""}),b.stickyHeaderAnimating(!1),a.resolve()},10)}).promise()}().done(function(){})})))},_animate:function(c){c=_.extend({direction:"down",force:!1,menu_wrapper:{},fast:!1},c||{});var d=a.Deferred(),e=this,f=c.menu_wrapper.length?c.menu_wrapper:b.$_header.find(e.currentStickySelector());e.scrollPosition();if(f.length){b.$_header.hasClass("fixed-header-on")||b.$_header.addClass("fixed-header-on");var g=function(){var a,g=f.outerHeight(),h=0;c.fast&&f.addClass("fast"),_.isFunction(window.matchMedia)&&matchMedia("screen and (max-width: 600px)").matches&&1==b.$_wpadminbar.length&&(h-=f.outerHeight()),a="up"==c.direction?"translate(0px, -"+g+"px)":"translate(0px, -"+h+"px)",e.stickyHeaderAnimating(!0),e.stickyHeaderAnimationDirection=c.direction,f.toggleClass("sticky-visible","down"==c.direction),f.css({"-webkit-transform":a,"-moz-transform":a,"-ms-transform":a,"-o-transform":a,transform:a}),_.delay(function(){e.stickyHeaderAnimating(!1),c.fast&&f.removeClass("fast"),d.resolve()},c.fast?100:350)};return _.delay(function(){var a=_.isString(f.attr("data-menu-id"))?f.attr("data-menu-id"):"";b.userXP.mobileMenu.has(a)?b.userXP.mobileMenu(a)("collapsed").done(function(){g()}):g()},50),d.promise()}}};b.methods.UserXP=b.methods.UserXP||{},a.extend(b.methods.UserXP,c)}(jQuery,czrapp);var czrapp=czrapp||{};!function(a,b){var c={sidebarLife:function(){var c=this;c.sidebars=new b.Values,a(".s1, .s2","#wrapper .main").each(function(d){if(1==a(this).length){var e,f=a(this),g=f.hasClass("s1")?"s1":"s2",h=f.attr("data-position");if(!_.isString(h))throw new Error("Missing sidebar position for "+s1);e=b.Value.extend(c.SidebarCTOR),c.sidebars.add(g,new e(g,{container:f,position:h,extended_width:"s1"==g?340:260}))}})},SidebarCTOR:{initialize:function(c,d){var e=this;e.id=c,a.extend(e,d||{}),e.button_selectors=".sidebar-toggle",e.button=e.container.find(e.button_selectors),b.Value.prototype.initialize.call(e,null,d),e.animating=new b.Value((!1)),e("collapsed"),e.bind(function(b){return a.Deferred(function(){var a=this;e._toggleSidebar().done(function(b){e.button.toggleClass("hovering","expanded"==b),a.resolve()})}).promise()},{deferred:!0}),e.validate=function(a){return e._isExpandable()?a:"collapsed"},b.setupDOMListeners([{trigger:"click keydown",selector:e.button_selectors,actions:function(){var a=this;b.userXP.sidebars.each(function(b){b(b.id==a.id?b():"collapsed")}),a("collapsed"==a()?"expanded":"collapsed")}},{trigger:"mouseenter",selector:e.button_selectors,actions:function(){this.button.addClass("hovering")}},{trigger:"mouseleave",selector:e.button_selectors,actions:function(){this.button.removeClass("hovering")}}],{dom_el:e.container},e),b.userXP.isResizing.bind(function(a){e(a?"collapsed":e())}),b.$_window.scroll(function(){e._isStickyfiable()&&e._stickify()}),e.isSticky=e.isSticky||new b.Value((!1)),b.userXP.stickyMenuDown.bind(function(a){b.userXP.sidebars.each(function(b){b._translateSbContent(a)})})},_translateSbContent:function(a){a=a||b.userXP.stickyMenuDown();var c=this,d=0,e=0,f="";c.isSticky()&&(1==b.$_wpadminbar.length&&(d+=b.$_wpadminbar.outerHeight(),e+=b.$_wpadminbar.outerHeight()),a&&_.isFunction(window.matchMedia)&&!matchMedia("screen and (max-width: 600px)").matches&&(d+=50)),f=a&&c.isSticky()?"translate(0px, "+d+"px)":"translate(0px, "+e+"px)",c.container.find(".sidebar-content, .sidebar-toggle").css({"-webkit-transform":f,"-moz-transform":f,"-ms-transform":f,"-o-transform":f,transform:f})},_mayBeTranslateIfExpandedSticky:function(){var a,b=this,c="expanded"==b(),d=b.extended_width-50;switch(b.position){case"right":d=-d;break;case"middle-right":d=-d;break;case"middle-left":case"left":d=0}d=c?d:-d,a="translate("+d+"px, 0px)",b.container.css({width:c?b.extended_width+"px":"50px","-webkit-transform":a,"-moz-transform":a,"-ms-transform":a,"-o-transform":a,transform:a})},_getXLeftOffset:function(){var c=this,d="expanded"==c(),e=a(".main","#wrapper"),f=e.find(".content"),g="";if(!c.isSticky())return"";switch(c.position){case"left":g=e.offset().left;break;case"middle-left":console.log(),g=("expanded"==b.userXP.sidebars("s1")()?50:b.userXP.sidebars("s1").container.width())+e.offset().left;break;case"middle-right":g=e.offset().left+f.width(),g=d?g-c.container.width()+50:g;break;case"right":g=e.offset().left+e.width()-c.container.width()}return _.isEmpty(g)?g:g+"px"},_getExpandedHeight:function(){var a=this,c=b.$_window.height(),d=this.container.find(".sidebar-content").height(),e=a._getMaxColumnHeight();return a.isSticky()?b.$_mainWrapper.offset().top+b.$_mainWrapper.find(".content").outerHeight()-a.container.offset().top:Math.max(c,d>e?e:d)},_getMaxColumnHeight:function(){var c=[];return b.userXP.sidebars.each(function(a){a.isSticky()||"expanded"==a()||c.push(a.container.outerHeight())}),a(".content","#wrapper .main").each(function(){1==a(this).length&&c.push(a(this).outerHeight())}),Math.max.apply(null,c)},_toggleSidebar:function(){var b=this,c="expanded"==b();return a.Deferred(function(){var d=this;(function(){return a.Deferred(function(){var a=this;if(b.animating(!0),b.container.toggleClass("expanding",c).toggleClass("collapsing",!c),b.isSticky()){var d,e;switch(b.position){case"right":case"middle-right":d=-(b.extended_width-50);break;case"middle-left":case"left":d=0}d=c?d:-d,e="translate("+d+"px, 0px)",b.container.css({width:c?b.extended_width+"px":"50px",height:c?b._getExpandedHeight()+"px":b.container.height()+"px","-webkit-transform":e,"-moz-transform":e,"-ms-transform":e,"-o-transform":e,transform:e})}else b.container.css({width:c?b.extended_width+"px":"50px"});b.container.find(".sidebar-content").css("opacity",c?0:1),b.container.find(".icon-sidebar-toggle").css("opacity",0),_.delay(function(){a.resolve()},350)}).promise()})().done(function(){b.container.toggleClass("expanded",c).toggleClass("collapsed",!c),b.container.removeClass("expanding").removeClass("collapsing").css({width:c?b.extended_width+"px":"",height:c?b._getExpandedHeight()+"px":"",left:b._getXLeftOffset(),"-webkit-transform":"","-moz-transform":"","-ms-transform":"","-o-transform":"",transform:""}),b.container.find(".icon-sidebar-toggle").css("opacity",1),b.container.find(".sidebar-content").css({opacity:1,height:c?"calc( 100% - 60px )":""}),b.animating(!1),d.resolve()})}).promise()},_stickify:function(){var c=this,d=b.$_window,e=b.$_mainWrapper,f=b.$_mainContent;if(1==e.length&&1==f.length){var g=c.container.outerHeight(),h=e.offset().top+c._getMaxColumnHeight(),i=(e.offset().top,0),j=d.scrollTop(),k=e.offset().top,l=h-(g+i),m="expanded"==c();l<0||(j>=l&&!m?(c.container.css({position:"",top:"",left:"",right:"","margin-left":"","margin-right":"","padding-bottom":"",height:""}),c.container.removeClass("sticky"),c.container.offset({top:h-g}),c.isSticky(!1)):j>=e.offset().top?(c.isSticky(!0),a.when(c.container.addClass("sticky")).done(function(){c._translateSbContent()}),c.container.css({top:"0px",height:m?c._getExpandedHeight()+"px":"",left:c._getXLeftOffset(),"margin-left":0,"margin-right":0,"padding-bottom":m?0:""})):j<k&&(a.when(c.container.removeClass("sticky")).done(function(){c._translateSbContent()}),c.container.css({position:"",top:"",left:"",right:"","margin-left":"","margin-right":"","padding-bottom":"",height:""}),c.isSticky(!1)))}},_isExpandable:function(){return _.isFunction(window.matchMedia)&&matchMedia("only screen and (min-width: 480px) and (max-width: 1200px)").matches},_isStickyfiable:function(){return _.isFunction(window.matchMedia)&&matchMedia("only screen and (min-width: 480px)").matches}}};b.methods.UserXP=b.methods.UserXP||{},a.extend(b.methods.UserXP,c)}(jQuery,czrapp);var czrapp=czrapp||{};!function(a,b){var c={outline:function(){b.$_body.hasClass("mozilla")&&"function"==typeof tcOutline&&tcOutline()},smoothScroll:function(){HUParams.SmoothScroll&&HUParams.SmoothScroll.Enabled&&smoothScroll(HUParams.SmoothScroll.Options)},toggleHeaderSearch:function(){a(".toggle-search").click(function(){a(".toggle-search").toggleClass("active"),a(".search-expand").fadeToggle(250),setTimeout(function(){a(".search-expand input").focus()},300)})},scrollToTop:function(){a("a#back-to-top").click(function(){return a("html, body").animate({scrollTop:0},"slow"),!1})},widgetTabs:function(){var b=a(".alx-tabs-nav"),c=b.children("li");a(".alx-tabs-container");b.each(function(){var b=a(this);b.next().children(".alx-tab").stop(!0,!0).hide().siblings(b.find("a").attr("href")).show(),b.children("li").first().addClass("active").stop(!0,!0).show()}),c.on("click",function(b){var c=a(this);c.siblings().removeClass("active").end().addClass("active"),c.parent().next().children(".alx-tab").stop(!0,!0).hide().siblings(c.find("a").attr("href")).fadeIn(),b.preventDefault()}).children(window.location.hash?'a[href="'+window.location.hash+'"]':"a:first").trigger("click")},commentTabs:function(){a(".comment-tabs li").click(function(){a(".comment-tabs li").removeClass("active"),a(this).addClass("active"),a(".comment-tab").hide();var b=a(this).find("a").attr("href");return a(b).fadeIn(),!1})},tableStyle:function(){a("table tr:odd").addClass("alt")},dropdownMenu:function(){a(".nav ul.sub-menu").hide(),a(".nav li").hover(function(){a(this).children("ul.sub-menu").slideDown("fast")},function(){a(this).children("ul.sub-menu").hide()})}};b.methods.UserXP=b.methods.UserXP||{},a.extend(b.methods.UserXP,c)}(jQuery,czrapp);var czrapp=czrapp||{};!function(a,b,c){a.localized=HUParams||{},b.extend(a,a.Events),a.Root=a.Class.extend({initialize:function(a){b.extend(this,a||{})},ready:function(){var b=this;b.dom_ready&&c.isArray(b.dom_ready)&&(a.status=a.status||[],c.each(b.dom_ready,function(d){if(c.isFunction(b[d]))try{b[d]()}catch(e){return void a.status.push(["NOK",b.id+"::"+d,c.isString(e)?a._truncate(e):e].join(" => "))}}))}}),a.Base=a.Root.extend(a.methods.Base),a.ready=b.Deferred(),a.bind("czrapp-ready",function(){a.consoleLog("front js ready"),a.ready.resolve()});var d={base:{ctor:a.Base,ready:["cacheProp"]},browserDetect:{ctor:a.Base.extend(a.methods.BrowserDetect),ready:["addBrowserClassToBody"]},jqPlugins:{ctor:a.Base.extend(a.methods.JQPlugins),ready:["imgSmartLoad","extLinks","parallax"]},userXP:{ctor:a.Base.extend(a.methods.UserXP),ready:["setupUIListeners","stickify","outline","smoothScroll","toggleHeaderSearch","scrollToTop","widgetTabs","commentTabs","tableStyle","sidebarLife","dropdownMenu","mobileMenu"]}};c.each(d,function(b,d){if(c.isObject(b))try{a[d]=new b.ctor({id:d,dom_ready:b.ready||[]})}catch(e){a.errorLog("Error when loading "+d+" | "+e)}}),b(function(b){c.each(d,function(b,d){c.isObject(a[d])&&c.isFunction(a[d].ready)&&a[d].ready()}),a.status=a.status||"OK",c.isArray(a.status)&&c.each(a.status,function(b){a.errorLog(b)}),a.trigger("czrapp-ready")})}(czrapp,jQuery,_);