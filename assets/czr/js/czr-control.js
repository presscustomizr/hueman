...
$.extend( CZRInputMths , {
    ...
    inputReact : function( to, from, data ) {
            ...
            if ( ! _.isEmpty( from ) || ! _.isUndefined( from ) && 'postMessage' === input.transport ) {
                  api.consoleLog('_sendInput(to, from) ?', input.id , data );
