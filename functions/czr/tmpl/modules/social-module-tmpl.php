...
function hu_print_social_tmpls() {
  ...
  <script type="text/html" id="tmpl-czr-module-social-pre-add-view-content">
    ...
    <div class="<?php echo $css_attr['sub_set_wrapper']; ?>" data-input-type="text">
      ...
      <div class="czr-input">
        <input data-czrtype="social-link" type="text" value="" placeholder="<?php _e('http://...', 'hueman'); ?>"></input>
      </div>
  ...
  <script type="text/html" id="tmpl-czr-module-social-item-content">
    ...
    <div class="<?php echo $css_attr['sub_set_wrapper']; ?>" data-input-type="text">
      ...
      <div class="czr-input">
        <input data-czrtype="social-link" type="text" value="{{ data['social-link'] }}" placeholder="<?php _e('http://...', 'hueman'); ?>"></input>
      </div>
    ...
    <div class="<?php echo $css_attr['sub_set_wrapper']; ?>" data-input-type="text">
      ...
      <div class="czr-input">
        <input data-czrtype="title" type="text" value="{{ data.title }}" placeholder="<?php _e('Enter a title', 'hueman'); ?>"></input>
      </div>
