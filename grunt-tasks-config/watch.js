module.exports = {
  ...
  front_css : {
    files : [
    '<%= paths.front_css %>bootstrap/dist/css/bootstrap-hueman.css',
    '<%= paths.front_css %>dev-common-parts/*.css',
    '<%= paths.front_css %>dev-common.css',
    '<%= paths.front_css %>dev-responsive.css',
    '<%= paths.front_css %>dev-font-awesome.css'
    ],
