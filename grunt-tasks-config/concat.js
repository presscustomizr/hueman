module.exports = {
  ...
  front_not_responsive_css: {
	...
	czr_control_js:{
      ...
      '<%= paths.czr_assets %>fmk/js/control_dev/_1_dyn_control_1_model.js',
      '<%= paths.czr_assets %>fmk/js/control_dev/_1_dyn_control_2_collection.js',
      '<%= paths.czr_assets %>fmk/js/control_dev/_1_dyn_control_3_view.js',
      '<%= paths.czr_assets %>fmk/js/control_dev/_1_dyn_control_4_dom_listeners.js',

      '<%= paths.czr_assets %>fmk/js/control_dev/_1_multi_input_control.js',
