...
# Changelog
= November 25 2015 - 2.2.5 =
* Added new languages
* Added option to turn on featured slideshow and speed - @raeffs (via GitHub)
* Added option to turn off post comments - @gregl83 (via GitHub)
* Added select element in themeform CSS - @pirmax (via GitHub)
* Added new input types in themeform CSS - @andreaskas (via GitHub)
* Replaced http:// with // for SSL - @IvanDoomer (via GitHub)
* Minor CSS fixes - @Zodiac1978 (via GitHub)

= November 24 2015 - 2.2.4 =
...
= September 3 2014 - 2.1.7 =
* Updated to Font Awesome 4.2.0
* Minor css fixes

= August 20 2014 - 2.1.6 =
